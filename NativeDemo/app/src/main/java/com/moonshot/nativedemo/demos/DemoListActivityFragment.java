 ...
 */
public class DemoListActivityFragment extends Fragment implements EasyPermissions.PermissionCallbacks, DemoListContract.DemoView  {
    ...
    private DemoListContract.Presenter mPresenter;
    ...
    @Override
    public void showDemoList(List<Demo> demos) {
        Log.d(TAG, "showDemoList");
        mAdapter.swapList(demos);
        mAdapter.notifyDataSetChanged();
    }

    @Override
    public void showDemoDetailsUI(View view, Demo demo) {
        mDemoListListener.onDemoClicked(view, demo);
    }
