...
package com.moonshot.nativedemo.VuforiaSamples.app.VideoPlayback;
...
import com.moonshot.nativedemo.SampleApplication.SampleApplicationSession;
import com.moonshot.nativedemo.SampleApplication.SampleAppRenderer;
import com.moonshot.nativedemo.SampleApplication.SampleAppRendererControl;
import com.moonshot.nativedemo.SampleApplication.utils.SampleMath;
import com.moonshot.nativedemo.SampleApplication.utils.SampleUtils;
import com.moonshot.nativedemo.SampleApplication.utils.Texture;
import com.moonshot.nativedemo.VuforiaSamples.app.VideoPlayback.VideoPlayerHelper.MEDIA_STATE;
import com.moonshot.nativedemo.VuforiaSamples.app.VideoPlayback.VideoPlayerHelper.MEDIA_TYPE;
...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    int videoPlaybackTextureID[] = new int[VideoPlaybackActivity.NUM_TARGETS];
    ...
    Vec3F targetPositiveDimensions[] = new Vec3F[VideoPlaybackActivity.NUM_TARGETS];
    ...
    MEDIA_STATE currentStatus[] = new MEDIA_STATE[VideoPlaybackActivity.NUM_TARGETS];
        ...
        SampleApplicationSession session)
    {
        ...
        mCanRequestType = new MEDIA_TYPE[VideoPlaybackActivity.NUM_TARGETS];
    ...
    void initRendering()
    {
        ...
        keyframeQuadAspectRatio[VideoPlaybackActivity.CHIPS] = (float) mTextures.get(1).mHeight
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            if (imageTarget.getName().compareTo("stones") == 0)
                currentTarget = VideoPlaybackActivity.STONES;
            else
        ...
        float[] textureCoordMatrix)
    {
        ...
        if (target == VideoPlaybackActivity.STONES)
        {
        ...
        } else if (target == VideoPlaybackActivity.CHIPS)
        {
            tempUVMultRes = uvMultMat4f(
