...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "com/moonshot/jnicallback/JniHandler");
...
Java_com_moonshot_jnicallback_JniCallbackActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_moonshot_jnicallback_JniCallbackActivity_StopTicks(JNIEnv *env, jobject instance) {
