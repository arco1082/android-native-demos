...
JNIEXPORT void JNICALL
    Java_com_moonshot_graph_AccelerometerGraphJNI_init(
    ...
    JNIEXPORT void JNICALL
    Java_com_moonshot_graph_AccelerometerGraphJNI_surfaceCreated(JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
    ...
    JNIEXPORT void JNICALL
    Java_com_moonshot_graph_AccelerometerGraphJNI_surfaceChanged(
    ...
    JNIEXPORT void JNICALL
    Java_com_moonshot_graph_AccelerometerGraphJNI_drawFrame(
    ...
    JNIEXPORT void JNICALL
    Java_com_moonshot_graph_AccelerometerGraphJNI_pause(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.pause();
    ...
    JNIEXPORT void JNICALL
    Java_com_moonshot_graph_AccelerometerGraphJNI_resume(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.resume();
